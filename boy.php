...
$subcatg=$_REQUEST['subcatg'];
   ...
   $sel=sqlsrv_query($con, "select * from items where catg='$catg' and subcatg='$subcatg'");
   echo"<form method='post'><table border='0' align='center'><tr>";
   $n=1;
    while($arr=sqlsql_fetch_array($sel, SQLSRV_FETCH_BOTH))
   {
   $i=$arr['itemno'];
    if($n%4==0)
	{
