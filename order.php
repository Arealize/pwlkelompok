...
if($_REQUEST['send'])
 ...
 if(sqlsrv_query($con,"insert into orders values('$pname','$itemno','$price','$size','$uname','$ac_no','$mob_no','$add','$bank','$city','$order_no')"))
    {
...
<?php
$sel=sqlsrv_query($con, "select * from register where id='$id'");
  $arr=sqlsrv_fetch_array($sel, SQLSRV_FETCH_BOTH);
...
<br><br>
    ...
    $mat=sqlsrv_fetch_array($sel, SQLSRV_FETCH_BOTH);
	?>
